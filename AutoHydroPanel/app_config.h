...
// 1 = synthetic telemetry, no controller needed. 0 = live UART to Parker.
// PlatformIO sets this per environment; the default is here so the sources also
// build in the Arduino IDE, which cannot pass -D flags.
#ifndef AUTOHYDRO_MOCK
#define AUTOHYDRO_MOCK 1
#endif
