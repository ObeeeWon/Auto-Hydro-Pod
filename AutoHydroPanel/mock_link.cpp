...
// The Arduino IDE compiles every source in the sketch folder, so this file has
// to compile away to nothing in the live build. PlatformIO excludes it instead.
#if AUTOHYDRO_MOCK
